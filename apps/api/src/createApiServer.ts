...
export const createApiServer = ({
  ...
  // State lives in ~/.kraken/projects/<name>/ when provided, else falls back to <project>/.kraken/
  const resolvedStateDir = projectStateDir ?? join(resolvedWorkspaceCwd, ".kraken");
