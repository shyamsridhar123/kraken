...
import {
  handleCommandDeckArmFleetRoute,
  handleCommandDeckArmItemRoute,
  handleCommandDeckArmSkillsRoute,
  handleCommandDeckArmsRoute,
  handleCommandDeckSkillsRoute,
  handleCommandDeckTodoAddRoute,
  handleCommandDeckTodoDeleteRoute,
  handleCommandDeckTodoEditRoute,
  handleCommandDeckTodoSolveRoute,
  handleCommandDeckTodoToggleRoute,
  handleCommandDeckVaultFileRoute,
} from "./commandDeckRoutes";
import {
...
import { handleArmGitPullRequestRoute, handleArmGitRoute } from "./gitRoutes";
import {
