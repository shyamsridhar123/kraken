...
export const CanvasTerminalColumn = ({
  ...
  const rawName = terminal?.armName ?? node.armId;
  const armName = rawName.length > 24 ? `${rawName.slice(0, 24)}...` : rawName;
    ...
    >
      <div className="canvas-terminal-column-header">
        <div className="canvas-terminal-column-heading">
          <h2>
            <span className="canvas-terminal-column-name">{armName}</span>
        ...
        <div className="canvas-terminal-column-actions">
          <span className="canvas-terminal-column-arm-tag" style={{ background: node.color }}>
            {node.armId}
          </span>
