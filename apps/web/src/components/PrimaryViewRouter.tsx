...
import { CommandDeckPrimaryView } from "./CommandDeckPrimaryView";
...
type PrimaryViewRouterProps = {
  ...
  deckPrimaryViewProps: ComponentProps<typeof CommandDeckPrimaryView>;
...
export const PrimaryViewRouter = ({
  ...
  if (activePrimaryNav === 2) {
    return <CommandDeckPrimaryView {...deckPrimaryViewProps} />;
  }
