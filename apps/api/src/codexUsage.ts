...
import { type ClaudeUsageSnapshot, asNumber, asRecord, asString } from "@kraken/core";
...
export type { ClaudeUsageSnapshot as CodexUsageSnapshot };
...
const mapUsageResponse = (response: CodexUsageApiResponse, now: Date): ClaudeUsageSnapshot => {
