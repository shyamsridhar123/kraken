...
// Walk: wave stride — motion ripples across arms left → right.
...
export type KrakenAnimation = "idle" | "sway" | "walk" | "jog" | "swim-up" | "bounce" | "float";
// "sleepy" is reserved for idle/inactive arms — never assign it randomly on creation.
export type KrakenExpression = "normal" | "happy" | "sleepy" | "angry" | "surprised";
export type KrakenAccessory = "none" | "long" | "mohawk" | "side-sweep" | "curly";
...
const HEADS: Record<KrakenExpression, string[][]> = {
...
function drawAccessory(
  ...
  switch (accessory) {
    case "long": {
      ...
      // Shaped like the pixel-art wig: covers top, frames face, strands reach arm area.
...
function buildFrameSequence(animation: KrakenAnimation): SpriteFrame[] {
  switch (animation) {
    case "swim-up":
...
function animationFrameMs(animation: KrakenAnimation): number {
