import type { AgentState, TerminalSnapshot, TerminalSnapshotReader } from "@kraken/core";
...
const isTerminalSnapshot = (value: unknown): value is TerminalSnapshot => {
  ...
  return (
    ...
    typeof snapshot.armId === "string" &&
    (snapshot.armName === undefined || typeof snapshot.armName === "string") &&
