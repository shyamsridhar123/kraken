...
import type { ArmGitStatusSnapshot, ArmPullRequestSnapshot } from "../app/types";
import { ActionButton } from "./ui/ActionButton";

type ArmGitActionsDialogProps = {
  armId: string;
  armName: string;
  gitStatus: ArmGitStatusSnapshot | null;
  gitPullRequest: ArmPullRequestSnapshot | null;
...
export const ArmGitActionsDialog = ({
  armId,
  armName,
  gitStatus,
  gitPullRequest,
  ...
  return (
    <section
      aria-label={`Git actions for ${armId}`}
    ...
    >
      ...
      <div className="git-actions-body">
        <p className="git-actions-message">
          Manage git lifecycle for <strong>{armName}</strong> ({armId}).
        </p>
        {isLoading ? (
        ...
        <section className="git-actions-commit-panel" aria-label="Source control composer">
          ...
          <textarea
            aria-label={`Commit message for ${armId}`}
