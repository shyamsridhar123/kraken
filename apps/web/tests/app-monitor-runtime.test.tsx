...
describe("App Monitor runtime", () => {
  ...
  it("saves X credentials, renders monitor feed rows, and supports manual refresh", async () => {
          ...
          posts: [
            {
              ...
              likeCount: 123,
              permalink: "https://x.com/kraken/status/1",
    ...
    await waitFor(() => {
      expect(within(telemetryTape).getAllByText("@kraken")).toHaveLength(2);
      ...
      expect(resourceLinks[0]).toHaveAttribute("href", "https://x.com/kraken/status/1");
    });
